...
/**
  ...
  * The enQueue and deQueue operations performed on the ImmutableQueue will essentially create a copy of ImmutableQueue. The original instance of ImmutableQueue will remain the same.
  *
