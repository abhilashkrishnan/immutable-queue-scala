...
/**
  ...
  * The enQueue and deQueue operations performed on the ImmutableQueue will essentially create a copy of ImmutableQueue. The original ImmutableQueue will remain the same.
  *
